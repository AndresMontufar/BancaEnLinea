...
export class HistorialCuentaPage implements OnInit {
  ...
  constructor(private router : Router, private historialCuentaService: HistorialCuentaService , private global: GlobalService, public alertController: AlertController) { }
